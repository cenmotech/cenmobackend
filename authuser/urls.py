...
from .views import register, login, logout, get_user_session, register_admin, edit_profile, get_user_profile, add_address, set_main_address
...
urlpatterns = [
    ...
    path('set-address/<str:id>', set_main_address, name='set-address'),
