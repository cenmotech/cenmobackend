...
urlpatterns = [
    ...
    path('get-all-listing-from-seller/<str:email>/<int:id>', get_all_listing_from_seller, name='get_all_listing_from_seller'),
    ...
    path('get_listing_by_id/<int:id>', get_listing_by_id, name='get_listing_by_id'),
